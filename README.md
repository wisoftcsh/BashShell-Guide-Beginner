...
>초기의 유닉스 셸인 본 셸(Bourne shell)과 새로 태어났다는 뜻의 영어 "born again"을 합친 이름이다. Bash는 1989년 브라이언 폭스에 의해 만들어졌다. 1990년 이후에는 쳇 레이미가 주로 관리하고 있다.
...
- Shell script to create MySQL database and user
	...
	```
	#!/bin/bash
    ok() { echo -e '\033[32m'$1'\033[m'; } # Green
